...
(function ($) {
  ...
  settings.LOGGING_SERVER = "MyServer";
  ...
  function processEventData(data) {
    ...
    if (settings.MODULE_ORIGIN) {
      ...
      //console.log("odsaAV...Sent to parent from instance number: " + data.uiid);
    }

    // Save the event in localStorage
    if (!!settings.LOGGING_SERVER && selfLoggingEnabled) {
      //console.log('odsaAV...Our server is  '+settings.LOGGING_SERVER+'  and logging is enabled!');
