    ...
    $(document).ready(function () {
        ...
        $('#jsav_problem_submit', element).click(function () {
            ...
            $.ajax({
                type: "POST",
                url: handlerUrl,
                data: JSON.stringify({"problem_url": problem_url,"weight": $("#jsav_problem_weight", element).val()}),
        ...
        $('#jsav_url_submit', element).click(function () {
            ...
            $.ajax({
                type: "POST",
                url: handlerUrl,
                data: JSON.stringify({"problem_url": $("#jsav_problem_url", element).val(), "weight": $("#jsav_problem_weight", element).val()}),
                success: location.reload()
            });
        });
