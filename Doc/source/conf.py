# -*- coding: utf-8 -*-
#
# OpenDSAX documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../../xblocks/XBlock'))
...
project = u'OpenDSAX'
copyright = u'2015 by OpenDSAX Project Contributors'
...
html_title = "OpenDSAX System Documentation"
...
man_pages = [
    ('index', 'opendsax', u'OpenDSAX Documentation',
     [u'Cliff Shaffer and Hosam Shahin'], 1)
]
